...
describe('FavoriteList Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'favorite-list', component: FavoriteListComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.favoriteLists?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to favoriteListService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFavoriteListIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFavoriteListIdentifier).toHaveBeenCalledWith(entity);
