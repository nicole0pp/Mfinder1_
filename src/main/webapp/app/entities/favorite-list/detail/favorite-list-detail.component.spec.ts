...
import { FavoriteListDetailComponent } from './favorite-list-detail.component';
...
describe('FavoriteList Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ favoriteList: { id: 123 } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load favoriteList on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.favoriteList).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
