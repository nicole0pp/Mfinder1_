...
describe('Rating Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rating', component: RatingEventComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ratingService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRatingEventIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRatingEventIdentifier).toHaveBeenCalledWith(entity);
